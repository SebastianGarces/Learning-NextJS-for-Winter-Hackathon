...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Prices, [{
    ...
    value: function render() {
      var list;
      this.state.currency === "USD" ? list = __jsx("li", {
        ...
        __self: this
      }, this.props.bpi.USD.rate)) : this.state.currency === "GBP" ? list = __jsx("li", {
        className: "list-group-item",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 22
        ...
        __self: this
      }, this.props.bpi.GBP.rate)) : this.state.currency === "EUR" ? list = __jsx("li", {
        className: "list-group-item",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 33
...
//# sourceMappingURL=index.js.2d7e1998ba7dbcb8337e.hot-update.js.map